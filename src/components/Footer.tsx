      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="col-span-2 md:col-span-1">
            <h3 className="font-bold text-lg mb-4 bg-gradient-to-r from-brand-gradient-start to-brand-gradient-end text-transparent bg-clip-text">
              SnapShare
            </h3>
            <p className="text-gray-600 mb-4">
              Share your moments with friends and family instantly.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-600 hover:text-brand-purple transition-colors">Download</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-600 hover:text-brand-purple transition-colors">Contact Us</a></li>
              <li><a href="#" className="text-gray-600 hover:text-brand-purple transition-colors">FAQs</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-600 hover:text-brand-purple transition-colors">Cookies Policy</a></li>
            </ul>
          </div>
        </div>
